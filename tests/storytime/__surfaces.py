...
from storytime.surfaces import Coord
def test__Coord( ) :
    coord = Coord( )
...
from storytime.surfaces import CoordR
def test__CoordR( ) :
    coord = CoordR( )
    coord0 = CoordR( [0, 0] )
...
from storytime.surfaces import CoordS2
def test__CoordS2( ) :
    coord = CoordS2( )
...
from storytime.surfaces import metric_sphere2
...
from storytime.surfaces import Surface
class __Surface :
...
from storytime.surfaces import SurfacePlane
...
from storytime.surfaces import SurfaceSphere2
